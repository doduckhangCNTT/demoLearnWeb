                ...
                <div className="flex-shrink-0 flex items-center">
                  <Link to="/" className="flex">
                    <img
                      ...
                      src="https://media.istockphoto.com/photos/graduation-hat-and-diploma-cartoon-style-with-clouds-on-abstract-3d-picture-id1338320564?s=612x612"
                      alt="Logo"
                    />
                    <h1 className="font-semibold ml-5 align-center">
                      LEARNING CODE
                    </h1>
                  </Link>
                </div>
